    ...
    <section className="py-24 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold text-foreground mb-6" data-testid="mystery-title">
            The <span className="text-primary">Journey</span> Begins
          </h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-8"></div>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-testid="mystery-description">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {/* Main Feature Card */}
          <div className="bg-gradient-to-br from-card to-card/50 border border-border/50 rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="text-center">
          <div className="inline-flex items-center space-x-3 bg-primary/10 border border-primary/30 rounded-full px-8 py-4">
